...
csv_names <- paste0('NO2_5cv_run2_', c('08-10', '09-11', '10-12', 
...
The model performance remains similar despite the time period. But from the variable importance, we can see that the longer the time period, the year becomes an important variable. It shows the importance of considering temporal variations over a long period.
